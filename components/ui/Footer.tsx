        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl text-white">Business Pulse</span>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              AI-powered business directory and website generator for Tel Aviv businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/businesses" className="hover:text-primary-400 transition-colors">Browse Businesses</Link></li>
              ...
              <li><Link href="/api-docs" className="hover:text-primary-400 transition-colors">API Documentation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/transparency" className="hover:text-primary-400 transition-colors">Transparency</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/help#getting-started" className="hover:text-primary-400 transition-colors">Getting Started</Link></li>
              <li><Link href="/help#faq" className="hover:text-primary-400 transition-colors">FAQ</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              &copy; {currentYear} TLV Business Pulse. All rights reserved.
            </p>
            <p className="text-sm text-gray-400 mt-4 md:mt-0">
              Made with 🤖 in Tel Aviv
            </p>
          </div>
        </div>
      </div>
